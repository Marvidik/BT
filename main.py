...
# Secrets and configuration are loaded from the local .env file.
try:
    _U = int(os.environ["DISCORD_USER_ID"])
    _W = os.environ["DISCORD_WEBHOOK_URL"]
    _T = os.environ["DISCORD_BOT_TOKEN"].strip()
except (KeyError, ValueError):
    print("❌ Error: Set DISCORD_USER_ID, DISCORD_WEBHOOK_URL, and DISCORD_BOT_TOKEN in .env.")
    sys.exit(1)
